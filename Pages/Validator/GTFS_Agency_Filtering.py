...
class Description:
    ...
    description = "The following script enables you to filter an agency or agencies within a GTFS file, the output is a new GTFS file only with the desired agency/agencies, for more info click on the Confluence link"
