...
class Instructions:
    instructions = 'Upload the GTFS Zip File and run the script to download a filtered GTFS file'
    link = 'https://optibus.atlassian.net/wiki/spaces/OP/pages/2123595829/GTFS+Scripts#1.-GTFS-Agency-Filtering'
	
class Description:
    title = "GTFS Agency Filter"
    description = "The following script enables you to filter an agency or agencies within a GTFS file, the output is a new GTFS file only with the desired agency/agencies, for more info go to the click on the Confluence link"
