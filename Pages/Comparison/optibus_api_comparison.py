from custom_import_method import import_with_logs

st = import_with_logs('streamlit')
requests = import_with_logs('requests')
json = import_with_logs('json')
logging = import_with_logs('logging')
time = import_with_logs('time')
re = import_with_logs('re')
pd = import_with_logs('pandas')
ExcelWriter = import_with_logs('pandas.ExcelWriter')
BytesIO = import_with_logs('io.BytesIO')
date = import_with_logs('datetime.date')
np = import_with_logs('numpy')
os = import_with_logs('os')
getcwd = import_with_logs('os.getcwd')
timedelta = import_with_logs('datetime.timedelta')
collections = import_with_logs('collections')
secrets = import_with_logs('secrets')
pl = import_with_logs('polars')
