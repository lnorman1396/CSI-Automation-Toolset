...
class Description:
    ...
    description = "The script converts the calendar_dates.txt file into a calendar.txt file and adds the relevant service IDs to the service IDs that already exist in the calendar.txt file if there are any. .ndar.txt file and adds the relevant service IDs to the service IDs that already exist in the calendar.txt file if there are any"
