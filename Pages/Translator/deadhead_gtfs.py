...
def run():
    ...
    if uploaded_file is not None:
        ...
        download = 1
        if download == 1:
            st.download_button("Download Excel File", output, 'Deadhead_Catalog' + '.xlsx', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')import streamlit as st
import os
import io
import zipfile
import pandas as pd
